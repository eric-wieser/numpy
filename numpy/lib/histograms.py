...
def _histogram_bins(a, bins, range, weights):
    """
    ...
    if isinstance(bins, basestring):
        ...
        if range is not None:
            _get_outer_edges(range)  # raise all the errors we used to
...
def histogram(a, bins=10, range=None, normed=False, weights=None,
    ...
    *includes* 4.
    ...
    bin_edges, uniform_bins = _histogram_bins(a, bins, range, weights)
